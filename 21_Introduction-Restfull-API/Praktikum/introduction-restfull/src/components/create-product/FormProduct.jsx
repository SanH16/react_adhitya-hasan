              ...
              {values.map((value) => (
                <tr>
                  <td
                    key={value.id}
                    className="fs-6"
                    onClick={() => handleProductDetail(value)}
                    style={{ cursor: "pointer" }}
                  >
                    {value.id} <strong>(show detail🚀)</strong>
                  </td>
                  <td>{value.productName}</td>
                  <td>{value.productCategory}</td>
                  <td>{value.flexradio}</td>
                  <td>{value.productPrice}</td>
                  <td>
                    <img className="rounded-3" style={{ height: "70px" }} src={value.formFile} alt={value.formFile} />
                  </td>
                  <td>
                    <button
